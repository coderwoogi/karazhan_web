...
func userStatusHandler(w http.ResponseWriter, r *http.Request) {
	...
	if mainCharGUID > 0 {
		charsDSN := "root:4618@tcp(localhost:3306)/acore_characters"
...
func serverOnlineHandler(w http.ResponseWriter, r *http.Request) {
	...
	dsn := "root:4618@tcp(localhost:3306)/acore_characters"
	db, err := sql.Open("mysql", dsn)
	if err != nil {
...
func handleGetServerEventsPublic(w http.ResponseWriter, r *http.Request) {
	...
	dbDSN := "cpo5704:584579@tcp(121.148.127.135:3306)/update"
...
func handleGetGameEvents(w http.ResponseWriter, r *http.Request) {
	// Connect to World DB
	dbDSN := "cpo5704:584579@tcp(121.148.127.135:3306)/acore_world"
	db, err := sql.Open("mysql", dbDSN)
	if err != nil {

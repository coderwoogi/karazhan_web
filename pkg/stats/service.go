...
func RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/content/trial/character-detail", handleTrialCharacterDetail)
	mux.HandleFunc("/api/content/trial/progress/save", handleTrialProgressSave)
	mux.HandleFunc("/api/content/trial/stage-record/save", handleTrialStageRecordSave)
	mux.HandleFunc("/api/content/trial/stage-record/delete", handleTrialStageRecordDelete)
	mux.HandleFunc("/api/content/trial/character/reset", handleTrialCharacterReset)
	mux.HandleFunc("/api/content/trial/character/force-clear", handleTrialCharacterForceClear)
